...
class SaberCSV:
    ...
    def _escape_csv_field(self, value: str) -> str:
        """
        Escapes double quote characters in a field by doubling them, as required by RFC 4180.
        Note: This method handles the doubling of quotes, while actual field quoting (wrapping fields in quotes for commas/newlines) is handled by csv.QUOTE_ALL in _write_tickets().
        """
        if not value:
            return ""
